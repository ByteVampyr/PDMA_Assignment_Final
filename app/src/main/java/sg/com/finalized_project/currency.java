...
public class currency extends AppCompatActivity {
    ...
    private String base_url = "http://rate-exchange.appapot.com/currency?"; //from USD tto BGN
    private AQuery api;
        ...
        button_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editText_currency.getText().toString().length() < 1 ) {
                    Toast.makeText(currency.this, "you have to write a value", Toast.LENGTH_SHORT).show();
                } else {
                ...
                aq.ajax(url, JSONObject.class, new AjaxCallback<JSONObject>() {
                    ...
                    @Override
                    public void callback(String url, JSONObject json, AjaxStatus Staus) {
                        ...
                        Toast.makeText(aq.getCode(), "Error:" + status.getCode(), Toast.LENGTH_LONG).show();
                    }
